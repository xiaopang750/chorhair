...
module.exports = function(app, route, preRoute) {
	...
	var Upload = Class.create(baseController, {
			...
			app.post(route, function(req, res) {
				...
				form.parse(req, function(err, fields, files) {
					...
					if (err) {
						...
						var ext = path.match(/(jpeg|gif|png|jpg|JPEG|GIF|PNG|JPG)/)[0];
		...
		uploadToFastDfsStr: function(baseStr, suc, fail) {
			...
			//把base64上传到fastDfs
			var _this = this;
			var ext = baseStr.match(/(jpeg|gif|png|jpg|JPEG|GIF|PNG|JPG)/)[0];
			if (ext == 'jpeg') ext = 'jpg';
			var baseStr = baseStr.replace(/data\:image\/(jpeg|gif|png|jpg|JPEG|GIF|PNG|JPG)\;base64\,/, "");

...
module.exports = function(app, route, preRoute) {
	...
	var Content = Class.create(baseController, {
		...
		initialize: function() {
			...
			this.events();
			this.contentModel = 'webRoot/views/shop/model/model2';
		...
		events: function() {
			...
			//查询
			app.all(preRoute + 'search', function(req, res){
				
				var param = _this.getParam(req);
				var sessionInfo = _this.readSession(req);
				param.pkShop = sessionInfo.pkShop;

				_this.request(req, res, _this.inter.content.search, param, function(data){

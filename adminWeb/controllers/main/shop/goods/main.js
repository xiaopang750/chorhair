...
module.exports = function(app, route, preRoute) {
	...
	var Goods = Class.create(baseController, {
		...
		events: function() {
			...
			//21.获取套餐对应商品
			app.all(preRoute + 'platCombo', function(req, res){

				var param = _this.getParam(req);

				_this.request(req, res, _this.inter.goods.platCombo, param, function(data){
			...
			//22.修改日志
			app.all(preRoute + 'modifyDetail', function(req, res){

				var param = _this.getParam(req);

				_this.request(req, res, _this.inter.goods.modifyDetail, param, function(data){

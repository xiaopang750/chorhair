/*TMODJS:{"version":113,"md5":"5c325c79a824132a50fae60d29ff3690"}*/
define(function(require) {
    return require("../../templates")("shop/system/fmlist", function($data) {
        "use strict";
        ...
        return $out += " ", $each(list, function($value, $index) {
            $out += " <tr sub-name-list> <td list-sort> ", $out += $escape($index + 1), $out += ' </td> <td can-edit sub-name="awardname" re="^\\w{1,10}$" msg="提成名称为10个字以内" tip="提成名称不能为空"> ', 
            ...
            1 == $value.israte && ($out += 'selected="selected"'), $out += '>比例提成</option> </select> </td> <td can-edit sub-name="awardmoney" ', 
            ...
            $out += $escape($value.pkFaireraward), $out += '" edit>编辑</a> <a href="javascript:;" aid="', 

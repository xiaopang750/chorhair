...
module.exports = function(app, express) {
	...
	if(env == 'test') {
		...
		cssPath = "/statics/build/css/";
		jsPath = "/statics/build/js/";
		...
		picDomain = 'http://chstatic.rsdataservice.com/';

		javaDomain = 'chser.nw.com';
		javaPort = 80;

		downloadDomain = 'http://chswx.rs07.com/';
		...
		fastDfsDomin = '10.165.122.59';
		fastDfsPort = 22122;
		fastDfsOverTime = 1000000;
		picDomain = 'http://image.chorhair.com/';

		javaDomain = 'server.nw.com';
		javaPort = 80; 

		downloadDomain = 'http://swx.chorhair.com/';
...
>>>>>>> .r2154
	...
	//downloadDomain
	app.set('downloadDomain', downloadDomain);

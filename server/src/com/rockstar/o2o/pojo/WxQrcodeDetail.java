...
public class WxQrcodeDetail implements java.io.Serializable {
	...
	/** full constructor */
	public WxQrcodeDetail(String sceneId, String accountId, String openid,
			String actionName, String ticket, String qrcodeUrl,
			String expireTime, String operateobject, String operatetype,
			Long pkKey, String ts, Short dr) {

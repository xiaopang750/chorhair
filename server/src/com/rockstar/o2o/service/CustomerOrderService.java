...
public interface CustomerOrderService {
	 ...
	 * @param id
	 */
	int FindShopDayOrder(String pkShop,String getdate);
	
	/**
	 * 根据店铺、日期、付款状态查询订单数量
	 * @param id
	 */
	List<CustomerOrder> FindByShopAndDateAndPay(String pkShop,String begintime,String endtime,String orderstatus,Integer curpage,Integer pagesize);
	 ...
	 * @param id
	 */
	List<CustomerOrder> querybycon(String pkShop,Integer curpage,Integer pagesize,String begintime,String endtime,String status);

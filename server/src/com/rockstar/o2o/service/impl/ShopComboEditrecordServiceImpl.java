...
public class ShopComboEditrecordServiceImpl extends BaseServiceImpl implements ShopComboEditrecordService{
	...
	public List<ShopComboEditrecord> QueryByCombo(String pkCombo) {
		...
		List<ShopComboEditrecord> editlists=(List<ShopComboEditrecord>) baseDao.pageQuery("from ShopComboEditrecord where IFNULL(dr,0)=0 and pkShopCombo = ?  order by edittime desc ",longpkCombo);
		return editlists;
	}

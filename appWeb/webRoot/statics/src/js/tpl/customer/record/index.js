/*TMODJS:{"version":224,"md5":"0ae7271b6c9f713cf0f388ddb6236ee8"}*/
define(function(require) {
    return require("../../templates")("customer/record/index", function($data) {
        "use strict";
        ...
        return $out += " ", $each(data, function($value) {
            ...
            $out += '</p> </dt> <dd class="ba-fl">  <div gallery-wrap class="photo-list ba-clearfix"> ', 

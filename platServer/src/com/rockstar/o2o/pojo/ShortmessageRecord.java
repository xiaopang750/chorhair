...
/**
 * ShortmessageRecord entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "shortmessage_record")
public class ShortmessageRecord implements java.io.Serializable {
	...
	/** full constructor */
	public ShortmessageRecord(String sender, String receiver, String content,
			String code, String messagetype, String messagegroup,
			String sendtime, String sendresult, String receivetime,
			String receiveresult, String ts, Short dr) {
		this.sender = sender;

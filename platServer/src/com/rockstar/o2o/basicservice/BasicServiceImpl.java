...
public class BasicServiceImpl implements BasicService{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Object> queryByMap(Class<?> c, String sql, Integer page, Integer size,
			Map<String, Object> map) {
		// TODO Auto-generated method stub
		return (List<Object>) basedao.queryHqlListByConMap("from " + c.getName()+" where IFNULL(dr,0)=0  "+sql,page,size,map);
	}

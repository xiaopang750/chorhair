...
public class CustomerOrderDetailServiceImpl extends BaseServiceImpl implements CustomerOrderDetailService{
	...
	@Override
	public List<CustomerOrderDetail> QueryByPkOrder(String pkOrder) {
		// TODO Auto-generated method stub
		Long longorder=Long.parseLong(pkOrder);
		List<CustomerOrderDetail>  detaillist=(List<CustomerOrderDetail>) baseDao.pageQuery("from CustomerOrderDetail where IFNULL(dr,0)=0 and pkOrder = ? ", longorder);
			return detaillist;
	}

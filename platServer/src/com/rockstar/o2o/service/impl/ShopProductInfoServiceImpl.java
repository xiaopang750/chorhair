...
public class ShopProductInfoServiceImpl extends BaseServiceImpl implements ShopProductInfoService{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<ShopProductInfo> getByProductid(Long pkProduct) {
		List<ShopProductInfo> productlists=(List<ShopProductInfo>) baseDao.pageQuery("from ShopProductInfo where IFNULL(dr,0)=0 and pkProduct = ? ",pkProduct);
		return productlists;
	}

package com.rockstar.o2o.dao.impl;
...
public class BaseDaoImpl  implements BaseDao{
	...
	public List<?> pageQueryByCon(String hql, Object... objects) {
		return pageQueryByCon(hql, null, null, objects);
	}

	//hql不分页条件查询
	public List<?> queryHqlListByConMap(String hql, Map<String, Object> map) {
		return queryHqlListByConMap(hql, null, null, map);
	}
	//hql分页条件查询
	@SuppressWarnings("rawtypes")
	@Override
	public List<?> queryHqlListByConMap(final String hql,final Integer page,final Integer size, final Map<String, Object> map) {
		return hibernateTemplate.executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException, SQLException {
				Query query = session.createQuery(hql);
				if (map != null) {
	...
	//sql不分页条件查询
	@Override
	public List<?> querySqlListByConMap(String sql, Map<String, Object> map) {
		return querySqlListByConMap(sql, null, null, map);
	}
	//sql分页条件查询
	@SuppressWarnings("rawtypes")
	@Override
	public List<?> querySqlListByConMap(final String sql,final Integer page,final Integer size, final Map<String, Object> map) {
		return hibernateTemplate.executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException, SQLException {
	...
	//sql不分页条件查询
	@Override
	public List<?> querySqlListByConMap2(String sql, Map<String, Object> map) {
		return querySqlListByConMap2(sql, null, null, map);
	}
	
	//sql分页条件查询
	@SuppressWarnings("rawtypes")
	@Override
	public List<?> querySqlListByConMap2(final String sql,final Integer page,final Integer size, final Map<String, Object> map) {
		return hibernateTemplate.executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException, SQLException {
				Query query = session.createSQLQuery(sql);
				if (map != null) {

...
define(function(require, exports, module) {
	...
	var oTplList = require('../../tpl/plat/platCode');
	var fenye = require('../../widget/dom/fenye');
	var Select = require('../../widget/dom/select');
	var oPublishTpl = require('../../tpl/plat/publishCode');
	var oDownloadTpl = require('../../tpl/plat/downloadCode');
	...
	var platCode = R.Class.create(R.util, {
		...
		publishCode: function(oBtn) {
			...
			if($('[code-type=shop]')[0].checked){
				...
				var pkShop = this.shop.children().eq(this.shop[0].selectedIndex).attr('pkKey');

...
define(function(require, exports, module){
	...
	lhgcalendar.fn = lhgcalendar.prototype =
	{
		...
		{	
			...
			//设置默认值 modify by wwc
			DOM.hour[0].value = that.config.defaultHour || (date.getHours() + '').replace(addzero,'0$1');
			DOM.minute[0].value = that.config.defaultMinutes || (date.getMinutes() + '').replace(addzero,'0$1');
			DOM.second[0].value = that.config.defaultSecond || (date.getSeconds() + '').replace(addzero,'0$1');

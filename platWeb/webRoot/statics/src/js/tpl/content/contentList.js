/*TMODJS:{"version":1,"md5":"04431acd0c322970a16ebc7f30d01fa4"}*/
define(function(require) {
    return require("../templates")("content/contentList", function($data) {
        "use strict";
        ...
        return $out += " ", list ? ($out += " ", $each(list, function($value) {
            ...
            $out += "?lid=", $out += $escape($value.pkContent), $out += '">详情</a> <a class="btn btn-normal ba-mr-5" contenturl="', 
            $out += $escape($value.contenturl), $out += '" href="javascript:;" remove cid="', 

/**
 *description:view-control-预约单编辑
 *author:fanwei
 *date:2015/1/7
 */
module.exports = function(app, route, preRoute) {
	...
	var Oappoint = Class.create(baseController, {
			...
			this.loadView({
				...
				beforeRender: function(req, res, page, commonData) {
					...
					_this.reqPrice(req, res, function(dataPrice){
						...
						_this.reqOther(req, res, param.spid, param.pkShop, function(dataOther){
		...
		reqPrice: function(req, res, cb) {
			...
			param.pkShop = this.getParam(req).pkShop;
		...
		reqOther: function(req, res, pid, pkShop, cb) {
